...
// Date:         2020-08-26
// Purpose:      Editor Reflection Utils
// **********************************************************************
using System;
...
{
    static Dictionary<KeyValuePair<object, string>, FieldInfo> mFieldInfoFromPaths = new Dictionary<KeyValuePair<object, string>, FieldInfo>();
    ...
    public static FieldInfo GetFieldInfoFromPath(object source, string path)
    {
        ...
        if (!mFieldInfoFromPaths.TryGetValue(kvp, out field))
        {
            ...
            mFieldInfoFromPaths.Add(kvp, field);
        }
