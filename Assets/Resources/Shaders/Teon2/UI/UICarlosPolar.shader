	...
	SubShader
	{
		...
		Pass
		{
			...
			struct v2f
			{
				...
				float2 ase_texcoord2 : TEXCOORD1;
			...
			v2f vert ( appdata v )
			{
				...
				o.ase_texcoord2.xy = _CustomData;
				o.ase_color = v.color;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float2 staticSwitch123 = ( staticSwitch144 + i.ase_texcoord2.xy );
				#else
