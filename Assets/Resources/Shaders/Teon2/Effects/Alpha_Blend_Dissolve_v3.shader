Shader "Teon2/Effects/Alpha_Blend_Dissolve_v3" {
    Properties {
    ...
    SubShader {
        ...
        Pass 
        {
            ...
            half4 frag(VertexOutput i) : COLOR 
            {
                ...
                half _DissolveThreshold = saturate(_DissolveTex_var.r / lerp( _DissolveItensity, step(_DissolveTex_var.r, i.uv1.r), _ParticalControl));
                ...
                half _Mask_var = tex2D(_Mask, TRANSFORM_TEX(i.uv0, _Mask));

                half3 finalColor = emissive + (_MainTex_var.rgb * _TintColor.rgb * i.vertexColor.rgb);
                fixed4 finalRGBA = fixed4(finalColor, ((i.vertexColor.a * _MainTex_var.a * _TintColor.a) * _DissolveThreshold) * _Mask_var);
