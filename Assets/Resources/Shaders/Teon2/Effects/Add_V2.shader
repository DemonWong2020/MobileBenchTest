...
////// Emissive:
                ...
                //half3 emissive = (_MainTex_var.a*i.vertexColor.a*_TintColor.a*(_MainTex_var.rgb*i.vertexColor.rgb*_TintColor.rgb)*saturate((sceneZ-partZ)/_Depth));
                half3 emissive = (_MainTex_var.a*i.vertexColor.a*_TintColor.a*(_MainTex_var.rgb*i.vertexColor.rgb*_TintColor.rgb));
