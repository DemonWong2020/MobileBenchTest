        ...
        SubShader 
        {
            Pass 
            {
                ...
                float4 frag (v2f i) : SV_Target
                {
                    ...
                    float4 col = i.color * UNITY_ACCESS_INSTANCED_PROP(Props, _TintColor) * tex2D(_MainTex, i.texcoord);
                    ...
                    col.a *= lerp(0.8, 1, _SelfItem) * _Fade;
                    col.rgb = lerp(col * 0.5 , col.rgb, _SelfItem);
