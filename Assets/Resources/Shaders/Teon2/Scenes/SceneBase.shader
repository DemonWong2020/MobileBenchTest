Shader "Teon2/Scenes/Base"
{
    Properties
    {
        ...
        _SnowNormalStrong("积雪法线强度", Range(0, 5)) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (v2f i) : SV_Target
            {
                ...
                float3 normal = lerp(half3(i.tSpace0.z, i.tSpace1.z, i.tSpace2.z), _NormalWorld, _SnowNormal) * snowMask.g * _SnowNormalStrong;
