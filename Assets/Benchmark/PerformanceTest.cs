...
namespace Benchmarking
{
    ...
    public class PerformanceTest : MonoBehaviour
    {
        ...
        private Button _changeDataButtonNext, _changeDataButtonPrev, _closeButton, _addButton, _deButton, _upButton;
        ...
        void Start()
        {
            ...
            _addButton = rootVE.Q<Button>(name: "AddButton");
            _addButton.style.opacity = 0;

            _deButton = rootVE.Q<Button>(name: "DeButton");
            _deButton.style.opacity = 0;

            _upButton = rootVE.Q<Button>(name: "UpButton");
            _upButton.style.opacity = 0;
            ...
            Debug.Log($"Previous TargetFrameRate: {_previousTargetFrameRate}");
        ...
        private void FinalizeTests()
        {
            ...
            _addButton.style.opacity = 1f;
            _addButton.clicked += () => { PerformScript.DownSample(); CloseBenchmark(); };

            _deButton.style.opacity = 1f;
            _deButton.clicked += () => { PerformScript.DeSample(); CloseBenchmark(); };

            _upButton.style.opacity = 1f;
            _upButton.clicked += () => { PerformScript.UpSample(); CloseBenchmark(); };
        }
        ...
        private void OnGUI()
        {
            GUI.Label(new Rect(10, 10, 300, 20), $"FPS: {fps:0.0}");
        }
    }
}