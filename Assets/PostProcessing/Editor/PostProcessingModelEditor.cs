    ...
    public class PostProcessingModelEditor
    {
        ...
        internal void OnGUI()
        {
            ...
            var display = alwaysEnabled
                ? EditorUtils.Header(serializedProperty.displayName, m_SettingsProperty, Reset)
                : EditorUtils.Header(serializedProperty.displayName, m_SettingsProperty, m_EnabledProperty, Reset);
