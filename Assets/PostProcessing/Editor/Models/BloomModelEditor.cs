...
namespace UnityEditor.PostProcessing
{
    ...
    public class BloomModelEditor : PostProcessingModelEditor
    {
        struct BloomSettings
        {
            ...
            public SerializedProperty thresholdMax;
        ...
        public override void OnEnable()
        {
            m_Bloom = new BloomSettings
            {
                ...
                thresholdMax = FindSetting((Settings x) => x.bloom.thresholdMax),
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_Bloom.threshold, EditorUtils.GetContent("Threshold (Gamma)"));
            EditorGUILayout.PropertyField(m_Bloom.thresholdMax, EditorUtils.GetContent("Brightness Multipy"));
