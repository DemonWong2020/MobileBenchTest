...
// FileName:     AmbientOcclusionModelEditor.cs
// Author:       Demon
...
namespace UnityEditor.PostProcessing
{
    ...
    public class AmbientOcclusionModelEditor : PostProcessingModelEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_HighPrecision, EditorUtils.GetContent("High Precision (Forward)"));

            using (new EditorGUI.DisabledGroupScope(m_ForceForwardCompatibility.boolValue))
                EditorGUILayout.PropertyField(m_AmbientOnly, EditorUtils.GetContent("Ambient Only (Deferred + HDR)"));
        }
    }
}
