...
// FileName:     CF_DrawingBluePrint.cs
// Author:       Demon
// UnityVersion：2019.4.39f1
// Date:         2024-11-18
// Purpose:      CameraFilterPack_Drawing_BluePrint
// **********************************************************************
...
{
    [System.Serializable]
    public class CF_DrawingBluePrint : CameraFilterBase
    {
        ...
        public override string ShaderName
        {
            get
            {
                return "Hidden/CF_DrawingBluePrint";
            }
        }
        ...
        protected override void Internal_Init()
        {
            ...
            Texture = Resources.Load("CameraFilterPack_Paper2") as Texture2D;
